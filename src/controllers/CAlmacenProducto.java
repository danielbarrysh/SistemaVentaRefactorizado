...
public class CAlmacenProducto extends JAbstractController implements Serializable{
    ...
    public AlmacenProducto getRegistro(Integer idalm,Integer idprd)
    {
        ...
        return !registros.isEmpty()?registros.get(0):null;
    }
    ...
    {
        Object suma =this.getSuma(AlmacenProducto.tablant, "cantidad_actual", "idproducto", idp);
    ...
    public boolean guardarRegistro(JAbstractModelBD mdl) {
        ...
        Object[] valores = {ap.getAlmacen().getPrimaryKey(),
         ...
         gravado = this.agregarRegistroPs(AlmacenProducto.tablant, this.stringToArray(campos, ","), valores);
        return gravado==1;       
    }
    ...
    public int actualizarRegistro(JAbstractModelBD mdl) {
        ...
        gravado = this.actualizarRegistroPs(AlmacenProducto.tablant, this.adjuntarSimbolo(campos, ",", "?")+Ex.WHERE+AlmacenProducto.COLUMNA_PK+" = ? ", valores);
        return gravado;
    }
    ...
    public ArrayList getRegistros(String[] campos, String[] columnaId, Object[] id) {
        ...
        try {
            ...
            if(id != null)
               this.numRegistros = this.getNumeroRegistros(AlmacenProducto.tablant, AlmacenProducto.COLUMNA_ACTIVO, AlmacenProducto.COLUMNA_ACTIVO, id);
            else
               this.numRegistros = this.getNumeroRegistros(AlmacenProducto.tablant, AlmacenProducto.COLUMNA_ACTIVO);               
               if(rs.isClosed())
                   System.out.println("resultset esta cerrado...");
            rs = this.getRegistros(AlmacenProducto.tablant,campos,columnaId,id);
