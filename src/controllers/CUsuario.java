...
public class CUsuario extends JAbstractController {
     ...
     *
     * @param mdl modelo
     * @param opcion si true llenara el modelos con todos los datos, de lo
     * contrario solo obtendra la clave primaria.
     * @return
     */
    @Override
    ...
    public ArrayList<Usuario> getRegistros(String[] campos, String[] columnaId, Object[] id) {
        ArrayList<Usuario> rgs = new ArrayList<>();
        try {
    ...
    public ArrayList<Usuario> getRegistrosMn(String[] campos, String[] columnaId, Object[] id) {
        ...
        try {
            ...
            while (rs.next()) {
                usuario = new Usuario();
                usuario.setPrimaryKey(rs.getInt(1));
                usuario.setIdu(rs.getInt(1));
                ...
                usuario.setSalt(rs.getString(9));
                usuario.setFechaNacimiento(rs.getInt(10));
                usuario.setFono(rs.getString(11));
                usuario.setFono2(rs.getString(12));
                usuario.setCelular(rs.getString(13));
                usuario.setNextel(rs.getString(14));
                usuario.setEmail(rs.getString(15));
                usuario.setSexo(rs.getString(16));
                usuario.setTipoCargo(rs.getString(17));
                usuario.setDescipcion(rs.getString(18));
                usuario.setActivo(rs.getInt(19));
                usuario.setFecRegistro(rs.getLong(20));
                usuario.setFecBaja(rs.getLong(21));
                rgs.add(usuario);
            }
        } catch (SQLException ex) {
        }
