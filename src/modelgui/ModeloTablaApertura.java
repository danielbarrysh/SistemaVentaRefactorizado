...
public class ModeloTablaApertura extends AbstractTableModel{
    private ArrayList<AlmacenProducto> aps = new ArrayList<>();
   ...
   // private Almacen almacen;
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        aps.get(rowIndex).setCantidadActual(Integer.valueOf(aValue.toString()));
    ...
    public class WrapperProductoAlmacen{
        ...
        public boolean equals(Object obj) {
            ...
            return !(this.almacen != other.almacen && (this.almacen == null || !this.almacen.equals(other.almacen)));
        }
    }
