...
public class ModeloTablaProducto extends ModeloTabla {
    ...
    /**
     * Indica si este modelo se aplicara a una tabla que se mostrara en un
     * formulario de busqueda,compra o venta
     *
     */
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (tipoTabla) {
            case BUSQUEDA:
                switch (columnIndex) {
                    case 0:
                        return ((Producto) registros.get(rowIndex)).getCodigoBarras();
                    case 1:
                        return ((Producto) registros.get(rowIndex)).getCodigo();
                    case 2:
                        return ((Producto) registros.get(rowIndex)).getNombre();
                    case 3:
                        return ((Producto) registros.get(rowIndex)).getCosto();
                }
                break;
            case COMPRA:
                switch (columnIndex) {
                    ...
                    case 2:
                        return ((Producto) registros.get(rowIndex)).getNombre();
                    case 3:
                        return ((Producto) registros.get(rowIndex)).getPrecioAlMayor();
                    case 4:
                        return ((Producto) registros.get(rowIndex)).getCosto();
                    case 5:
                        return ((Producto) registros.get(rowIndex)).getUtilidad();
                    case 6:
                        return ((Producto) registros.get(rowIndex)).getStockMinimo();
                }
                break;
            case VENTA:
                switch (columnIndex) {
                    case 0:
                        return ((Producto) registros.get(rowIndex)).getNombre();
                    case 1:
                        return ((Producto) registros.get(rowIndex)).getUnidadPrincipal();
                    case 2:
                        return ((Producto) registros.get(rowIndex)).getPrecioAlMayor();
                    case 3:
                        return ((Producto) registros.get(rowIndex)).getPrecioAlMenor();
                }
                break;
            default:
                return null;
