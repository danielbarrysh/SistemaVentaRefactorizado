...
public class AlmacenProducto extends JAbstractModelBD implements Serializable,IModel{
    ...
    public static final String tablant = "gv_almaceproduct";
    ...
    public boolean equals(Object obj) {
        ...
        return !(!Objects.equals(this.idpa, other.idpa) && (this.idpa == null || !this.idpa.equals(other.idpa)));
    }
