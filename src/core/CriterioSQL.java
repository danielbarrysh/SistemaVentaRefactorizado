...
public class CriterioSQL {
    ...
    public class Condicion {
        ...
        /**
         * var operadorBoleano almacena solo un operador para comparacion de
         * texto especificamente '_' , '%' soloe puede almacenar uno y no mas.
         */
    ...
    public String getSQLfromWhere() {
        ...
        if (this.limite > -1) {
            consulta += " limit ";
            if (this.desplazamiento > -1) {
                consulta += this.desplazamiento + ",";
            }
            consulta += this.limite;
        }
        String sql = this.procesaCondicion() + this.groupBy + this.having + this.orderBy + consulta;
