...
public class IProducto extends javax.swing.JInternalFrame {
    ...
    public void setValoresProducto(Producto prd)
    {
        ...
        prd.setCosto(Double.valueOf(this.ftxtCosto.getValue().toString()));
        prd.setPrecioAlMayor(Double.valueOf(this.ftxtPrecioAlMayor.getValue().toString()));
        prd.setPrecioAlMenor(Double.valueOf(this.ftxtPrecioAlMenor.getValue().toString()));
        prd.setUtilidad(Integer.valueOf(this.ftxtUtilidad.getValue().toString()));
        prd.setAplicaIGV(1);
        if(!this.chbAplicarIGV.isSelected())
        {
            prd.setAplicaIGV(0);
        }
        prd.setStockMinimo(Integer.valueOf(this.ftxtStockMinimo.getValue().toString()));
        ...
        prd.setPeso(Double.valueOf(this.ftxtPeso.getValue().toString()));
    }
    ...
    private void setValoresCampos(Producto prd)
    {
       ...
       Enumeration<AbstractButton> elements = buttonGroup1.getElements();
        ...
        for(int i=0;i<ic;i++)
        {
            ...
            if(!Objects.equals(primaryKey, prd.getIdMoneda()))
            {
            } else {
    ...
    private void setValuesCombos(JComboBox cb,Integer id)
    {
       int ic = cb.getItemCount(); 
        for(int i=0;i<ic;i++)
        {
            ...
            if(Objects.equals(primaryKey, id))
            {
