 ...
 */
public final class ISimpleModelo extends javax.swing.JInternalFrame {
    ...
    private final CSimpleModelo cGeneral;
...
private void formInternalFrameClosing(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosing
    ...
    {        
        ListSelectionListener lst = (ListSelectionEvent e) -> {
            setDatoModelo();
        };
        this.tblModelo.getSelectionModel().addListSelectionListener(lst);
        
        ListSelectionListener lstmc = (ListSelectionEvent e) -> {
            setDatoMarca();
        };
        this.tblMarca.getSelectionModel().addListSelectionListener(lstmc);
        
        ListSelectionListener lstcl = (ListSelectionEvent e) -> {
            setDatoClase();
        };
