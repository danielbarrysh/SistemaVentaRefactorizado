...
public class ICompra extends javax.swing.JInternalFrame {
    ...
    {
        TableModelListener tml = this::tableHandlerEvent;
        ...
        if(rp)
        {
            ...
            if(productosEliminados != null)
            {
               ...
               if(!productosEliminados.isEmpty())
                {
                   for (DetalleCompra item : productosEliminados) {
           ...
           ftfcampo.addKeyListener(new KeyListener(){
                ...
                public void keyReleased(KeyEvent e) {                    
                    if(e.getKeyCode() == KeyEvent.VK_ENTER)
                    {
                        ...
                        valorActual = Double.valueOf(tmp.getValue().toString());
                        if(valorActual != null)
                        {
                        ...
                        //setTotales();
                            ...
                            mtdc.setValueAt(Double.valueOf(valorActual.toString())*pr, filaSeleccionada, 4);                       
                            mtdc.contarItems();
                            fireEditingStopped();
                        }                        
                    }
